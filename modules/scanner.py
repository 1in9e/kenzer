...
class Scanner:
    ...
    def s3hunt(self):
        ...
        os.system("s3-hunter -l {0} -t 6 -T 100 -o {1} --only-direct".format(subs, output))
    ...
    def favinize(self):
        ...
        os.system("favinizer -d {2}/favinizer.yaml -t 6 -T 100 -l {0} -o {1}".format(subs, out, self.templates))
